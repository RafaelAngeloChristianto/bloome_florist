    ...
    <nav className="w-full fixed top-0 z-50 bg-white/90 backdrop-blur-md border-b border-white/20">
      <div className="max-w-7xl mx-auto px-3 sm:px-6">
        <div className="flex justify-between items-center py-2 sm:py-4">
          ...
          >
            {/* Logo Image */}
            <div className="w-10 h-10 rounded-xl overflow-hidden shadow-md bg-gradient-to-br from-rose-100 to-pink-100 p-[2px]">
              <img
                src={logo}
                alt="Bloome Flowers Logo"
            ...
            <div className="leading-tight text-left">
              ...
              <p className="text-[10px] text-rose-400 tracking-[0.25em] font-medium">
                FLOWERS
              </p>
            </div>
          </button>
          ...
          <div className="hidden lg:flex items-center gap-6 xl:gap-8">
            ...
            >
              HOME
              <span
                className={`absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-rose-500 to-pink-500 transition-all duration-300 ${
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                BOUQUETS
                <svg
                  className={`w-4 h-4 transition-transform duration-300 ${isFlowersOpen ? "rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                  ...
                  <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          {catalogueItems.map((item, idx) => (
                            <button
                              key={idx}
                              onClick={() =>
                                handlePageChange("catalogues", item.name)
                              }
                            ...
                            >
                              ...
                              <div className="text-left">
                                <p className="text-sm font-semibold text-gray-800 group-hover:text-rose-600 transition-colors">
                                  {item.name}
                                </p>
                    ...
                    <div className="px-8 py-6 bg-gradient-to-r from-rose-50/50 to-pink-50/50 border-t border-white/20 flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Our floral experts are here to help
                        </p>
                      </div>
                      <button
      ...
      {/* MOBILE MENU */}
      <div
        className={`lg:hidden transition-all duration-300 ${isMobileMenuOpen ? "max-h-[calc(100vh-4rem)] opacity-100" : "max-h-0 opacity-0"} overflow-hidden`}
      >
        <div className="bg-white/95 backdrop-blur-md border-t border-gray-200 px-3 sm:px-6 py-4 space-y-3 overflow-y-auto max-h-[calc(100vh-4rem)]">
          ...
          <div>
            ...
            >
              BOUQUETS
              <svg
                className={`w-4 h-4 transition-transform ${isMobileBouquetOpen ? "rotate-180" : ""}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <div
              className={`transition-all duration-200 ${isMobileBouquetOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"} overflow-y-auto`}
            >
